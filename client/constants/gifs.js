import success from "../assets/gifs/success.json";
import processing from "../assets/gifs/processing.json";
...
import recording from "../assets/gifs/recording.json";

export default {
  recording,
  Processing_exp_date_blue,
  Processing_exp_date_yellow,
  success,
  processing,
  fake_product,
  loading,
